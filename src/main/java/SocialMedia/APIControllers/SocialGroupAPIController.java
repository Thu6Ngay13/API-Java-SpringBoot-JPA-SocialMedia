...
public class SocialGroupAPIController {
	...
	public ResponseEntity<?> getGroupsByUsername(@PathVariable(value = "username") String username) {
		...
		return new ResponseEntity<Response>(
				new Response(true, "Thành công", groupModels), 
				HttpStatus.OK
		);
	}
	
	@GetMapping("/{groupId}")
	public ResponseEntity<?> getPostByGroupId(
    ...
    public ResponseEntity<?> createGroup(@RequestParam("username") String username, @RequestParam("groupName") String groupName,
    	...
    	if (success)
    	{
    		...
    		return new ResponseEntity<Response>(
    				new Response(true, "Thành công", groupModel),
    				HttpStatus.OK
    		);
    	}
